...
def main():
    ...
    if (args.bot == "gpt3" and args.api == None):
        print("You should enter your openai API if you want to use GPT3 as your bot")
        raise
...
def set_arguments(parser):
    ...
    parser.add_argument("--model", type=str, help="Load pretrained model") # load prompted model if we need to finetune or testing.
